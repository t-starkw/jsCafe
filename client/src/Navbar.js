...
//           <main className="font-spacemono bg-white dark:bg-black px-8">
//             <nav className="flex justify-between text-black dark:text-white gap-2 p-2">
//               <a
//                 href="/"
//                 className="flex justify-between text-4xl px-4 bg-white dark:bg-black"
//               >
//                 JsCafe
//               </a>
//               <a>
...
//                   className="flex cursor-pointer text-3xl text-black dark:text-white"
//                 />
//               </a>
//               <ul>
//                 <li>
//                   <a
//                     href="/menu"
//                     className="flex justify-between px-4 cursor-pointer capitalize font-medium bg-white dark:bg-black"
//                   >
//                     Menu
//                   </a>
//                 </li>
